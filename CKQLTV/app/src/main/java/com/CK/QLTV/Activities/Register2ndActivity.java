    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        BTN_signup_next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //nếu người đầu tiên đăng ký sẽ có quyền quản lý
                if(!khachHangDAO.KtraTonTaiKH()){
                    quyenDAO.ThemQuyen("Quản lý");
                    quyenDAO.ThemQuyen("Khách hàng");
                    khachHangDTO.setMAQUYEN(1);
                }else {
                    khachHangDTO.setMAQUYEN(2);
                }

                //Thêm khách hàng dựa theo obj KHDTO
                long ktra = khachHangDAO.ThemKhachHang(khachHangDTO);
                if(ktra != 0){
